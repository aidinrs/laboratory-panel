...
class Introduction extends React.Component {
  ...
  allIssuedAssets () {
    axios.get(`${NETWORK.available.main.horizonURL}/assets`, {params: {asset_issuer: ISSUING_ACC, limit: 200}}).then((res) => {
  ...
  allBaseTxs () {
    axios.get(`${NETWORK.available.main.horizonURL}/accounts/${BASE_ACC}/transactions`, {params: {limit: 200}}).then((res) => {
      if (res.data && res.data._embedded && Array.isArray(res.data._embedded.records)) {
        this.setState({
          body: res.data._embedded.records,
  ...
  allBaseEffects () {
    axios.get(`${NETWORK.available.main.horizonURL}/accounts/${BASE_ACC}/effects`, {params: {limit: 200}}).then((res) => {
      if (res.data && res.data._embedded && Array.isArray(res.data._embedded.records)) {
        this.setState({
          body: res.data._embedded.records,
  ...
  allBasePayments () {
    axios.get(`${NETWORK.available.main.horizonURL}/accounts/${BASE_ACC}/payments`, {params: {limit: 200}}).then((res) => {
      if (res.data && res.data._embedded && Array.isArray(res.data._embedded.records)) {
        this.setState({
          body: res.data._embedded.records,
  ...
  allBaseOffers () {
    axios.get(`${NETWORK.available.main.horizonURL}/accounts/${BASE_ACC}/offers`, {params: {limit: 200}}).then((res) => {
      if (res.data && res.data._embedded && Array.isArray(res.data._embedded.records)) {
        this.setState({
          body: res.data._embedded.records,
