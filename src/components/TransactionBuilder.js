...
class TransactionBuilder extends React.Component {
  constructor (props) {
    super(props)
    if (props.user && props.user.accountId) {
      onAttributeUpdate(props.dispatch, 'sourceAccount', props.user.accountId)
    }
  }
      ...
      <div className="so-back">
        <div className="so-chunk">
          <div className="pageIntro">
            ...
            <p>
              این تراکنش در ابتدا به هیچ گونه امضایی نیاز ندارد و تنها در صورتی که لازم باشد تا در شبکه منتشر شود باید
              امضا شود.
            </p>
          </div>
          ...
          <div className="TransactionOperations__add">
            <button className="TransactionOperations__add__button s-button btn-warning"
